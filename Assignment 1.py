...
def lineplot(data): 
    """
    Generate Line Plot for UK Transport From 2020 to 2023

    Parameters
    data:csv
    
    data taking from a csv file
...
def scatterplot(data):
    ...
    """
    Generate Scatter Plot for UK Transport From 2020 to 2023
...
def barchat(data):
    ...
    """
    Generate Bar Chart for UK Transport From 2020 to 2023
